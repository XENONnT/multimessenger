...
singularity shell --bind /project2/ --bind /scratch/midway3/$USER --bind /scratch/midway2/$USER  --bind /project/lgrandi /project2/lgrandi/xenonnt/singularity-images/{tag} 
<<EOF
